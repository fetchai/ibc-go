...
We ensure all major releases are supported by relayers ([hermes](https://github.com/informalsystems/ibc-rs), <!-- markdown-link-check-disable -->[rly](https://github.com/strangelove-ventures/relayer)<!-- markdown-link-check-enable --> and [ts-relayer](https://github.com/confio/ts-relayer) at the moment) which can relay between the new major release and older releases. We have no plans of upgrading to an IBC protocol specification v2.0, as this would be very disruptive to the ecosystem.
