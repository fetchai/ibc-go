...
then set the bank module's [`SendEnabled` parameter](https://github.com/cosmos/cosmos-sdk/blob/v0.45.4/x/bank/spec/05_params.md#sendenabled) for the denomination to `false`.
