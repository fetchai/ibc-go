...
### [Clients](https://github.com/cosmos/ibc-go/blob/v3.1.0/modules/core/02-client)
...
* [Solo Machine light client](https://github.com/cosmos/ibc-go/blob/v3.1.0/modules/light-clients/06-solomachine): Devices such as phones, browsers, or laptops.
* [Tendermint light client](https://github.com/cosmos/ibc-go/blob/v3.1.0/modules/light-clients/07-tendermint): The default for Cosmos SDK-based chains.
* [Localhost (loopback) client](https://github.com/cosmos/ibc-go/blob/v3.1.0/modules/light-clients/09-localhost): Useful for
...
### [Connections](https://github.com/cosmos/ibc-go/blob/v3.1.0/modules/core/03-connection)
...
### [Proofs](https://github.com/cosmos/ibc-go/blob/v3.1.0/modules/core/23-commitment) and [Paths](https://github.com/cosmos/ibc-go/blob/v3.1.0/modules/core/24-host)
...
### [Capabilities](https://github.com/cosmos/cosmos-sdk/blob/v0.45.4/docs/core/ocap.md)
...
capability store](https://github.com/cosmos/cosmos-sdk/blob/v0.45.4/docs/architecture/adr-003-dynamic-capability-store.md). Upon binding to a port or
...
### [Ports](https://github.com/cosmos/ibc-go/blob/v3.1.0/modules/core/05-port)
...
### [Channels](https://github.com/cosmos/ibc-go/blob/v3.1.0/modules/core/04-channel)
...
### [Packets](https://github.com/cosmos/ibc-go/blob/v3.1.0/modules/core/04-channel)
...
### [Receipts and Timeouts](https://github.com/cosmos/ibc-go/blob/v3.1.0/modules/core/04-channel)
...
### [Acknowledgments](https://github.com/cosmos/ibc-go/blob/v3.1.0/modules/core/04-channel)
